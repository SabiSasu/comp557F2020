...
public class A3App implements SceneGraphNode {
	...
	public static void main(String[] args) {
		...
		String windowTitle = "Bezier Patch Drawer (Sabina Sasu - 260903977)";
	...
	public A3App() {
		...
		//patchwork = new BezierPatchWork("data/a3data/circlePatch.txt");
		//patchwork = new BezierPatchWork("data/a3data/testCusp.txt");
	...
	@Override
	/**
	 * Draws the scene (this is called by the windowing system every time the scene
	 * needs to be drawn)
	 */
	public void display(GLAutoDrawable drawable, ShadowPipeline pipeline) {
		...
		// TODO: Note that the world frame is on the plane, but loaded models are
		// displayed slightly above!!!
